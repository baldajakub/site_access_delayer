...
async function loadSites() {
  try {
    ...
    if (!sites || sites.length === 0) {
      ...
      sites = ["reddit.com", "youtube.com", "facebook.com"];
    ...
    if (sites.length === 0) {
      ...
      emptyMessage.textContent = "No sites blocked yet. Add some above!";
    ...
    siteList.innerHTML =
      '<div class="empty-message">Error loading sites: ' +
      error.message +
      "</div>";
  }
}
